...
Name:           ros-lyrical-gz-math-vendor
Version:        0.4.5
Release:        1%{?dist}
...
%description
Vendor package for: gz-math 9.3.0 Gazebo Math : Math classes and functions for
robot applications
...
%changelog
* Thu Aug 27 2026 Addisu Z. Taddese <addisuzt@intrinsic.ai> - 0.4.5-1
- Autogenerated by Bloom

* Wed Jul 22 2026 Addisu Z. Taddese <addisuzt@intrinsic.ai> - 0.4.4-1
- Autogenerated by Bloom
